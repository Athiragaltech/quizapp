...
from .models import PhoneNumber  # Import your PhoneNumber model
...
class UserRegistrationForm(UserCreationForm):
    ...
    def save(self, commit=True):
        ...
        PhoneNumber.objects.create(user=user, phone_number=phone_number)  # Ensure PhoneNumber model has user field
        return user
