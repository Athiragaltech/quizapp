...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0002_alter_phonenumber_phone_number'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', django_extensions.db.fields.AutoSlugField(blank=True, editable=False, null=True, populate_from='course_name', unique=True)),
